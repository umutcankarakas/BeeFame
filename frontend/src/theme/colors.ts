...
export const blue = withAlphas({
  lightest: '#B3C3E0', // Açık ton, soft mavi ton
  light: '#849ABD', // Orta açık ton
  main: '#062A54', // Ana renk
  dark: '#041D3A', // Koyu ton
  darkest: '#021228', // En koyu ton
  contrastText: '#FFFFFF', // Tüm seçeneklerde kontrast beyaz
});
