                    ...
                    <FormControl>
                      <Paper elevation={0} sx={{ borderRadius: 2, border: '1px solid', borderColor: 'divider', overflow: 'hidden' }}>
                        ...
                        <Box sx={{ p: 2 }}>
                          {mitigationTab === 0 && (
                            <Stack spacing={2}>
                              {mitigations.filter((m) => m.type === 'Preprocessing').map((mitigation) => (
                                <Paper
                                  key={mitigation.id}
                                  elevation={0}
                          ...
                          {mitigationTab === 1 && (
                            <Stack spacing={2}>
                              {mitigations.filter((m) => m.type === 'Inprocessing').map((mitigation) => (
                                <Paper
                                  key={mitigation.id}
                                  elevation={0}
                                  onClick={() => handleMitigationSelect(mitigation.name)}
                          ...
                          {mitigationTab === 2 && (
                            <Stack spacing={2}>
                              {mitigations.filter((m) => m.type === 'Postprocessing').map((mitigation) => (
                                <Paper
                                  key={mitigation.id}
                                  elevation={0}
                                  onClick={() => handleMitigationSelect(mitigation.name)}
